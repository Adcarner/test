...
public class AccountTest {
	...
	public static void main(String[] args) {
		testAccountCreation();
		testToString();
		testDeposit();// TODO Auto-generated method stub
...
private static void testDepositWithNegativeAmount() {
	System.out.println("-->testDepositWithNegaticeAmount()");
	Account a1 = new Account(1000.0);
	a1.deposit(-500.0);
	System.out.println("balance should be $1000, balance=$" + a1.getBalance());
}
private static void testMultipleDeposits() {
	...
	a1.deposit(500.0);
	a1.deposit(300.0);
	System.out.println("balance shoud be $1800, balance=$" + a1.getBalance());
}
...
private static void testMultipleDepositsAndWithdrawals() {
	System.out.println("-->testMultipleDepostisAndWithdrawals()");
	Account a1 = new Account(1000.0);
	a1.deposit(500.0);
	a1.withdraw(200.0);
	a1.deposit(400.0);
